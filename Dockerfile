...
COPY --from=build /app/scripts/benchmark-ollama-models.mjs ./scripts/benchmark-ollama-models.mjs
COPY --from=build /app/scripts/ollama-benchmark-harness-lib.mjs ./scripts/ollama-benchmark-harness-lib.mjs
