...
function buildUiConfig(env: Environment = process.env, version = '') {
  ...
  return {
    ...
    PAPERLESS_API_TOKEN: '',
    PAPERLESS_API_TOKEN_CONFIGURED: Boolean(env.PAPERLESS_API_TOKEN),
    ...
    OPENCODE_API_KEY: '',
    OPENCODE_API_KEY_CONFIGURED: Boolean(env.OPENCODE_API_KEY),
    ...
    COPILOT_GITHUB_TOKEN_CONFIGURED: Boolean(env.COPILOT_GITHUB_TOKEN),
    COPILOT_MODEL: env.COPILOT_MODEL || getDefaultModel('copilot'),
    COMPATIBLE_API_KEY: '',
    COMPATIBLE_API_KEY_CONFIGURED: Boolean(env.COMPATIBLE_API_KEY || env.CUSTOM_API_KEY),
    ...
    AZURE_API_KEY: '',
    AZURE_API_KEY_CONFIGURED: Boolean(env.AZURE_API_KEY),
    ...
    API_KEY: '',
    API_KEY_CONFIGURED: Boolean(env.API_KEY),
    AI_REASONING_EFFORT: env.AI_REASONING_EFFORT || 'auto',
